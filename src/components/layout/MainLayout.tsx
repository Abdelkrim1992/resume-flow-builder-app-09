        ...
        <div className="max-w-md mx-auto">
          <div className="flex justify-around items-center h-16">
            ...
            <Link to="/templates" className={cn(
              "flex flex-col items-center justify-center w-full h-full text-xs",
              isActive("/templates") ? "text-resume-primary" : "text-gray-500"
            )}>
              <FileText size={20} />
            ...
            <Link to="/favorites" className={cn(
              "flex flex-col items-center justify-center w-full h-full text-xs",
              isActive("/favorites") ? "text-resume-primary" : "text-gray-500"
            )}>
              <Heart size={20} />
            ...
            <Link to="/settings" className={cn(
              "flex flex-col items-center justify-center w-full h-full text-xs",
              isActive("/settings") ? "text-resume-primary" : "text-gray-500"
            )}>
              <Settings size={20} />
